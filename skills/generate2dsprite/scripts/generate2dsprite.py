...
def cmd_process(args: argparse.Namespace) -> None:
    ...
    elif not args.allow_missing_prompt:
        raise ValueError("Missing prompt provenance: pass --prompt-file <bundle>/source/prompt-used.txt or --prompt, or use --allow-missing-prompt only for legacy/non-generated assets.")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    process_parser.add_argument("--allow-missing-prompt", action="store_true", help="Allow legacy/non-generated processing without writing prompt-used.txt.")
